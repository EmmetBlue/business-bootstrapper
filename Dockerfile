...
RUN apt-get update -yq && apt-get install -yq git curl g++ make unixodbc-dev && rm -rf /var/lib/apt/lists/*
ADD . /var/www/html/bootstrapper
RUN mkdir /var/www/html/condra-cloud /var/www/html/condra-cloud/globals /var/www/html/condra-cloud/api /var/www/html/condra-id
